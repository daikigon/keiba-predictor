...
export default async function DataPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">ばんえい競馬 データ管理</h1>
        <p className="text-gray-500 mt-1">ばんえい競馬のレースデータスクレイピングと状況確認</p>
      </div>
      ...
      {isBackendAvailable ? (
        <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-purple-800">ローカルバックエンド接続中</h3>
      ...
      <div className="grid gap-6 lg:grid-cols-2 mb-8">
        ...
        {stats ? (
          <Card>
            <CardHeader>
              <CardTitle>ばんえい競馬統計（{isBackendAvailable ? 'ローカルDB' : 'Supabase'}）</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                <p># 特定の日付を取得（帯広のばんえい競馬）</p>
                <p className="text-green-400">python3 scripts/scrape_banei.py --date 2024-12-22</p>
                <p className="mt-2"># 期間指定でスクレイピング</p>
                <p className="text-green-400">python3 scripts/scrape_banei.py --start 2024-12-01 --end 2024-12-22</p>
                <p className="mt-2"># データ件数確認</p>
                <p className="text-green-400">python3 scripts/scrape_banei.py --stats</p>
              </div>
            </div>
