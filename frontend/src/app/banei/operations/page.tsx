...
const SCRAPE_HISTORY_KEY = 'keiba_scrape_history_banei';
...
export default function OperationsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">ばんえい競馬 運用管理</h1>
        <p className="text-gray-500 mt-1">ばんえい競馬のデータ取得・予測処理の管理</p>
      </div>
