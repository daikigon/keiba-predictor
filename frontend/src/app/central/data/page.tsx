...
async function getStats() {
  try {
    return await getScrapeStats('central');
  } catch {
    return null;
  }
}
...
export default async function DataPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">中央競馬 データ管理</h1>
        <p className="text-gray-500 mt-1">中央競馬のレースデータスクレイピングと状況確認</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2 mb-8">
        ...
        {stats ? (
          <Card>
            <CardHeader>
              <CardTitle>中央競馬統計（{isBackendAvailable ? 'ローカルDB' : 'Supabase'}）</CardTitle>
            </CardHeader>
            <CardContent>
