...
async function getTodayRaces() {
  try {
    ...
    return await getRaces(today, 'central');
  } catch {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">中央競馬 ダッシュボード</h1>
          ...
          <Card>
            ...
            <CardContent>
              {racesData.races.length > 0 ? (
                <RaceList races={racesData.races.slice(0, 6)} baseUrl="/central" />
              ) : (
